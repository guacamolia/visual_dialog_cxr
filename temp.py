...
pa_images = []
with open('/home/okovaleva/visdiag/dataset/mimic-cxr-map-View-Position.csv') as csvfile:
    reader = csv.reader(csvfile, delimiter='\t')
    for row in reader:
        if row[-1] == "PA":
            pa_images.append(row[3])

with open('/home/okovaleva/visdiag/image_features/PA_ids/id_list.txt', 'w') as f:
    for item in pa_images:
        f.write(f"{item}.dcm\n")
